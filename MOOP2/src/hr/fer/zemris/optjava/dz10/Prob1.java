...
import hr.fer.zemris.optjava.dz10.func.PowFunc;
import hr.fer.zemris.optjava.dz10.interfaces.IFunc;

import java.util.LinkedList;

public class Prob1 implements MOOPProblem{
	...
	public Prob1(int problem1DomainDim, double[] prob1Min, double[] prob1Max) {
	...
	public double[] getObjectiveMax() {
		double value = Constants.UPPER_BOUNDARY_PROB2_X1*Constants.UPPER_BOUNDARY_PROB2_X1;
